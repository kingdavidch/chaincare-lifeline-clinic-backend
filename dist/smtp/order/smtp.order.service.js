...
class OrderSmtpService {
    ...
    static sendOrderConfirmationEmail(order) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const testRows = order.tests
                .map((test) => {
                var _a, _b, _c, _d;
                const testName = test === null || test === void 0 ? void 0 : test.testName;
                const price = (test === null || test === void 0 ? void 0 : test.price) ? test.price.toFixed(2) : "0.00";
                const individuals = (_a = test === null || test === void 0 ? void 0 : test.individuals) !== null && _a !== void 0 ? _a : 1;
    ...
    static sendOrderStatusUpdateEmail(order, testItem, clinic, patient) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const coords = (_a = clinic.location) === null || _a === void 0 ? void 0 : _a.coordinates;
            let googleMapLink = "";
            let clinicAddress = "";
